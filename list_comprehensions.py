...
fruits_with_more_than_two_vowels = [fruit for fruit in fruits if 
        len([vowel for vowel in fruit if vowel in 'aeiou']) > 2]
...
fruits_with_five_or_more = [fruit for fruit in fruits if 
        len(fruit) > 5]

# Exercise 6 - make a list that contains each fruit with exactly 5 characters
fruits_with_only_five = [fruit for fruit in fruits if 
        len(fruit) == 5]

# Exercise 7 - Make a list that contains fruits that have less than 5 characters
fruits_with_less_than_five = [fruit for fruit in fruits if 
        len(fruit) < 5]

# Exercise 8 - Make a list containing the number of characters in each fruit. 
# Output would be [5, 4, 10, etc... ]
fruits_letters = [len(fruit) for fruit in fruits]
...
# Exercise 13 - Make a variable named negative_numbers that holds 
...
two_or_more_num = [n for n in numbers if n >=10 or n<=-10]
...
# BONUS Make a variable named "primes" that is a 
# list containing the prime numbers in the numbers list. 
